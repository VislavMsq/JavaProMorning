package lesson1Class;
import lesson1Class.animals.Animal;
import lesson1Class.animals.Snake;
import lesson1Class.animals.Tiger;
import lesson1Class.cats.Cat;
import lesson1Class.cats.Lion;
import lesson1Class.institute.TelRan;
public class Main {
    /*
    План занятия
    1) Классы
...
//        telRan1.performLection();                   корректную работу данного части кода
    ...
    public void start(){
    TelRan telRan = new TelRan();   // Композиция и агрегация(просто почитать и попробовать понять суть)
     telRan.init();
     telRan.performLection();
    }
